...
const SubProgramGanttChart = ({ selectedSubProgramId, selectedSubProgramName, selectedProgramName, selectedProgramId, onNavigateUp, onBackToProgram, onBackToWelcome }) => {
    ...
    const processedData = useMemo(() => {
        ...
        const timelineFilteredProjects = programFilteredProjects.filter(project => {
            const projectForFiltering = {
                ...
                // CRITICAL FIX: Include milestones so projects with only milestones (no start/end dates) are included
                milestones: project.milestones || [],
                phases: project.phaseData || []
            };
    ...
    return (
        <div className="w-full flex flex-col relative">
            ...
            {((cacheLoading && !subProgramData) || (loading && allData.length === 0)) && !error && (
